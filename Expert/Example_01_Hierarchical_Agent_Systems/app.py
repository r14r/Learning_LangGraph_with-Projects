...
st.title("🎯 Hierarchical Agent Systems")
st.markdown(f"### Example 1: Multi-level agent architecture")

st.markdown(f"""
This Expert level example demonstrates: **Multi-level agent architecture**
